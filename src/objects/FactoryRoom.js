...
class FactoryEnvironment extends Scene {
    ...
    constructor(renderer = null, segmentCount = 1) {
        ...
        const roomZPosition = -( segmentCount * SEGMENT_LENGTH - SEGMENT_LENGTH ) / 2

        const room = new Mesh(geometry, roomMaterial);
        room.position.set(0, 13.219, roomZPosition);
        room.scale.set(SEGMENT_WIDTH, 28.305, segmentCount * SEGMENT_LENGTH);
        this.add(room);
        ...
        light4.position.set(- 0.462, 8.89, 14.520 + SEGMENT_LENGTH*segmentCount);
        light4.scale.set(4.38, 5.441, 0.088);
        this.add(light4);

        // -z
        const light5 = new Mesh(geometry, createAreaLightMaterial(20));
        light5.position.set(3.235, 11.486, - 12.541 - SEGMENT_LENGTH*segmentCount);
